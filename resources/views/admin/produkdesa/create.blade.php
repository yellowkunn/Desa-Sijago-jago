...
@section('container')
    <div class="max-w-3xl mx-auto py-12 px-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Tambah Produk Desa</h1>

        <form action="{{ route('produkdesa.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
