...
@section('container')
    <div class="max-w-3xl mx-auto py-12 px-6">
        ...
        <form action="{{ route('produkdesa.updatekonten') }}" enctype="multipart/form-data" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                @if ($produkdesa && $produkdesa->background)
                    <img src="{{ asset($produkdesa->background) }}" id="currentBackground"
