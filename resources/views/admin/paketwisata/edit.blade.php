...
@section('container')
    <div class="max-w-3xl mx-auto py-12 px-6">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Tampilan Produk Desa</h1>

        <form action="{{ route('paketwisata.updatekonten') }}" enctype="multipart/form-data" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                @if ($paketwisata && $paketwisata->background)
                    <img src="{{ asset($paketwisata->background) }}" id="currentBackground"
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4" class="w-full border rounded-lg p-3 mt-1" required>{{ old('deskripsi', $deskripsi) }}</textarea>
            </div>
