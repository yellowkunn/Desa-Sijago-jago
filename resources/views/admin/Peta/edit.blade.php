...
@section('container')
    <div class="max-w-3xl mx-auto py-12 px-6">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Tampilan Peta</h1>

        <form action="{{ route('peta.updatekonten') }}" enctype="multipart/form-data" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                @if ($peta && $peta->background)
                    <img src="{{ asset($peta->background) }}" id="currentBackground"
